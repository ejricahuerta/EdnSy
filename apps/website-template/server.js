...
app.get("/", (req, res) => {
  res.status(200).json({
    ...
    endpoints: {
      ...
      "GET /api/render-test": "Render HTML; ?json= & ?style=dental-v1..dental-v6 & ?layout=admin|lead-rosetta",
      "GET /images/*": "Static dental stock images (3x2, 9x16) for rendered HTML",
      "GET /style-guides/dental/images/*": "Optional style-guide assets",
