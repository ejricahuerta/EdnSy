...
When you have **services**, **valuePropositions**, or **about.values**, render cards that feel like functional micro-UIs, not static template blocks. Prefer **3 cards** when data allows; derive from `valuePropositions` or first 3 services.
