...
| Id | Title | Notes |
|----|--------|--------|
| 1 | Landing page and marketing site | `/`, hero, pricing, CTAs, style guide. |
...
| **docs/next-steps-first-send.md** | Already accurate (Supabase, Resend, Add test client, Send from dashboard). No change. |
...
- **Dashboard:** `/dashboard` (overview), `/dashboard/clients` (prospects table, create demo, approve, send), `/dashboard/[id]` (prospect detail), `/dashboard/integrations`, `/dashboard/billing`, `/dashboard/settings`, etc.
