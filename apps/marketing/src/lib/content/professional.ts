/**
 * Professional demo: consultants, coaches, accountants, etc.
 * Same content shape as other industries for template reuse.
 */
export const professionalDemoContent = {
	header: {
	...
	hero: {
		...
		urgencyText: '',
		image: '/images/demo/professional/hero.jpg',
	...
	whyUs: {
		...
		items: [
			{ title: 'Experienced', description: 'Years of experience in my field. I stay current on best practices and bring that knowledge to every engagement.' },
			{ title: 'Clear communication', description: 'No jargon or runaround. I explain options plainly and help you make informed decisions.' },
			{ title: 'Personal approach', description: 'You work directly with me. No handoffs or generic plans. Advice tailored to your situation.' }
		]
	},
	services: {
		heading: 'Services',
		...
		items: [
			{ title: 'Initial consultation', description: 'A focused session to understand your situation, outline options, and agree on next steps. Often the best place to start.', icon: 'MessageCircle' },
			{ title: 'Strategy & planning', description: 'Structured support to set goals, build a plan, and stay on track. Ideal for projects or longer-term objectives.', icon: 'Target' },
			{ title: 'Ongoing support', description: 'Retainer or regular check-ins so you have consistent access to advice and accountability when you need it.', icon: 'CalendarCheck' }
		]
	},
	about: {
		heading: 'About me',
		subtext: 'I built my practice on referrals and repeat clients. My job is to give you clear, actionable guidance so you can move forward with confidence.',
		subtext2: 'I work with individuals and small businesses. Every engagement is confidential and tailored to your goals.',
		bullets: [
		...
		image: '/images/demo/professional/about.jpg',
	...
	newPatients: {
		...
		steps: [
			{ title: 'Book a call', description: 'Use the button above or email to schedule a short intro call. No obligation.' },
			{ title: 'We discuss your needs', description: 'I\'ll ask a few questions and outline how I can help. You\'ll get a clear sense of scope and fees.' },
			{ title: 'We get to work', description: 'If we both agree it\'s a fit, we schedule our first session and take it from there.' }
		],
		ctaLabel: 'Book a consultation',
	...
	testimonials: {
		...
		items: [
			{ quote: 'Exactly the clarity I needed. One consultation gave me a roadmap I could actually follow. Highly recommend.', author: 'R. M.', role: 'Client', rating: 5 },
			{ quote: 'Professional, responsive, and straight to the point. Felt like I had a real partner in my corner.', author: 'J. K.', role: 'Client', rating: 5 },
			{ quote: 'We did a short engagement that turned into ongoing support. Worth every penny for the peace of mind.', author: 'S. T.', role: 'Client', rating: 5 }
		]
	},
	insurance: {
