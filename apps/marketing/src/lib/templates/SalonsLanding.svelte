...
<style>
	.salons-landing details summary::-webkit-details-marker {
		display: none;
	}
	.salons-landing a:focus-visible,
	.salons-landing button:focus-visible {
		outline: 2px solid oklch(var(--p));
		outline-offset: 2px;
	}
	.salons-landing .section-heading {
	...
	.salons-landing .section-lead {
		color: oklch(var(--bc) / 0.8);
		line-height: 1.7;
		max-width: 42rem;
	}
	.salons-landing .prose-block {
		max-width: 42rem;
		line-height: 1.75;
	}
</style>
