...
- **[CHANGELOG.md](./CHANGELOG.md)** – Human-readable history of what changed in each version.
- **PRD** (`docs/prd.md`) – Product requirements; has its own document version (e.g. PRD v0.2).

When you add features or fix bugs, update `docs/CHANGELOG.md` under `[Unreleased]`. When you decide to cut a new release, add a new `## [x.y.z] - date` section and move the relevant entries there.
