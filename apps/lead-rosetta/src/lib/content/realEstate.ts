...
export const realEstateDemoContent = {
	...
	insurance: {
		...
		body: 'Commission structure is explained clearly before you sign anything. For buyers, my fee is typically covered by the listing. For sellers, we discuss lead-rosetta and commission in our initial meeting. No hidden fees.'
	},
	stats: [
