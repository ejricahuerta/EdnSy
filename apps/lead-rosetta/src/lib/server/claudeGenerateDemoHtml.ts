 ...
 * Paid demos use pitch-rosetta single-file HTML.
 */
...
/** Inline prompt for 3-part demo: use index.json only, output HTML only. Full cinematic spec lives in pitch-rosetta. */
