 ...
 * expected by Pitch Rosetta (index.json shape). Handles hours normalization,
...
import type { PitchRosettaPayload } from '$lib/types/pitchRosettaPayload';
...
export type TransformToPitchRosettaPayloadInput = {
 ...
 * Pitch Rosetta expects (business, hero, images, services, insurance, about,
 ...
 */
export function transformToPitchRosettaPayload(input: TransformToPitchRosettaPayloadInput): PitchRosettaPayload {
	...
	const payload: PitchRosettaPayload = {
		business: {
			name,
