...
create table if not exists public.agent_content_versions (
...
comment on table public.agent_content_versions is 'Versioned prompt and knowledge_base overrides for AI agents; default remains in code.';
comment on column public.agent_content_versions.agent_id is 'design | demo-chat | demo-creation';
comment on column public.agent_content_versions.content_type is 'prompt | knowledge_base';
