...
// Load .env from agent folder or parent (pitch-rosetta)
...
/**
 * Upload HTML to Supabase Storage: lead-rosetta-bucket / demo-html/{id}.html
...
async function main() {
  ...
  console.log("Pitch Rosetta Website Agent (branding → plan → generate)");
