...
<section class="py-16 md:py-24 bg-muted/30">
  <div class="max-w-6xl mx-auto px-6 lg:px-8">
    ...
    <p class="mt-8 text-muted-foreground">
      See our main <a href="/ai-automation-toronto" class="text-primary underline">AI Automation Toronto</a> page or <a href="/contact" class="text-primary underline">contact us</a> for a free strategy call.
    </p>
  </div>
</section>
...
<section class="py-16 md:py-24 bg-background">
  <div class="max-w-6xl mx-auto px-6 lg:px-8 text-center">
    <h2 class="typography-h2 mb-3">Ready to get started?</h2>
    <p class="text-muted-foreground mb-6 max-w-xl mx-auto">Book a free strategy call. We'll outline a custom plan for your GTA business. No commitment.</p>
